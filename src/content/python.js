...
export const pythonLessons = [
  {
    ...
    skill: 'print',
    time: '02:14',
    story: '02:14. Ты внутри — но экран пуст. Пока система не ответит хоть чем-то, ты не знаешь, жива ли она вообще.',
...

  {
    ...
    skill: 'переменные',
    time: '02:26',
    story: 'Позывной, адрес шлюза, код смены. Держать в голове — забудешь, записать на бумаге — найдут. Система умеет помнить за тебя.',
...

  {
    ...
    skill: 'числа',
    time: '02:38',
    story: 'У тебя ограниченное число попыток и ограниченное время до пересменки. И то и другое надо считать, а не прикидывать.',
...

  {
    ...
    time: '02:50',
    story: 'Перехваченная строка приходит с мусором по краям и в чужом регистре. Прежде чем сравнивать — приведи к порядку.',
...

  {
    ...
    time: '03:02',
    story: 'Номер пропуска на вид число, а на деле строка. Пока не превратишь — не посчитаешь и не сравнишь.',
...

  {
    ...
    time: '03:14',
    story: 'Система задаёт ровно один вопрос: ты свой? Ответ всегда один из двух, и его нужно уметь получить.',
...

  {
    ...
    skill: 'if / elif / else',
    time: '03:26',
    story: 'Шлюз не размышляет — он выбирает одну из веток. Твоя задача написать обе, включая ту, которая тебе не нравится.',
...

  {
    ...
    time: '03:38',
    story: 'Настоящая защита проверяет не одно условие, а несколько. Запомни разницу между «и» и «или»: в финале ты вскроешь чужой контур ровно на ней.',
...

  {
    ...
    time: '03:50',
    story: 'Целей больше одной. Держать их в отдельных переменных — верный способ однажды перепутать.',
...

  {
    ...
    skill: 'for, range',
    time: '04:02',
    story: 'Руками по одной — до утра не успеешь. Пусть перебирает система, а ты смотри на результат.',
...

  {
    ...
    skill: 'while, break',
    time: '04:12',
    story: 'Сколько будет попыток — заранее неизвестно. Известно только, когда пора остановиться и уходить.',
...

  {
    ...
    skill: 'dict',
    time: '04:20',
    story: 'На каждую цель заводится карточка: адрес, важность, состояние. Ровно так же выглядит ответ любого сервера.',
...

  {
    ...
    skill: 'def, return',
    time: '04:27',
    story: 'Один и тот же приём повторяется всю ночь. Опиши его один раз и дальше зови по имени.',
...

  {
    ...
    time: '04:33',
    story: 'Связь рвётся, данные приходят битыми, шлюз отвечает мусором. Инструмент, который падает на первом сбое, ночь не переживёт.',
...

  {
    ...
    time: '04:37',
    story: 'Разрозненные приёмы — ещё не инструмент. Перед последним шагом собери их в одну панель, с которой можно работать не глядя.',
...

  {
    ...
    time: '04:41',
    story: '04:41. Осталось одно. Свой сервер ты защищаешь сам — и сам же проверяешь, выдержит ли он тебя.',
    preamble: SERVER,
