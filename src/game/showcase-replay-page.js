...
document.querySelector('#receipt').textContent = `1280×720 · ${replay.fps} кадров/с · ${replay.durationMs/1000} с · переход на склад: кадр ${replay.cutFrame}. Две доставки через движок → $240; роборука выключена.`;
