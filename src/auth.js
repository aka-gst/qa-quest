 ...
 *
 * Протокол намеренно повторяет тот, что уже работает в Лиле
 * (backend/server.py): те же /api/auth/* и та же кука leela_auth с Path=/.
 * Пока сервис не поднят на домене, QA Quest продолжает работать
 * без входа и хранит прогресс в браузере.
 */
